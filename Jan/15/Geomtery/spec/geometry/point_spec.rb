...
describe Geometry::Point do
  ...
  it "calculates the distance between two points in millimetres" do
    point2 = Geometry::Point.new(point.x + 1, point.y + 1)
    expect(point.distance(point2)).to eq(Math.sqrt(2) * 10)
  end

  it "calculates the distance between two points in centimetres" do
    point2 = Geometry::Point.new(point.x+1, point.y+1)
    expect(point.distance(point2)).to be Math.sqrt(2)
  end

  it "calculates the distance between two points in metres" do
    point2 = Geometry::Point.new(point.x+1, point.y+1)
    expect(point.distance(point2)).to be Math.sqrt(2)
  end
  ...
  it "calculates the distance between another point along the Y axis" do
    ...
    expect(point.y_distance(point2)).to eq(2.0)
  end
end